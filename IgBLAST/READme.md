...
The reference germline sequences were sourced from **Mus musculus (mouse)** IMGT data.
...
The database was built following the guidelines provided by **[NCBI IgBLAST](https://ncbi.github.io/igblast/cook/How-to-set-up.html)**, ensuring compatibility with IgBLAST’s sequence alignment and annotation tools.
