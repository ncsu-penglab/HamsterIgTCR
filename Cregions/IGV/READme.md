...
Our findings indicate that there is **no read support for the intron retention event** proposed by *Oliver et al.*, thereby supporting the **Adams et al. (2025)** annotation. The absence of read evidence suggests that the intron retention is likely an **assembly error**.
