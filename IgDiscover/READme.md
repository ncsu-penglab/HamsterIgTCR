...
The yaml files uses permissive parameters to handle single-end Iso-Seq reads for V gene segment discovery in hamster.

## Snakefile
This is the modifed Snakefile used for the IgDiscover analysis.

## predicted_genes
This folder contains IgDiscover predicted V gene segments using IgDiscover. 
